...
export default function UpdateInventory() {
    ...
    const handleSubmit = async (e) => {
        ...
        // Prepare only fields needed by backend
        const data = {
            productId: e.target.productId.value,
            warehouse: e.target.location.value || "unknown",
            quantity: parseInt(e.target.stockToAdd.value),
            status: "in_stock" // default since FE doesn't ask for status
        };
        ...
        try {
            ...
            alert("Backend error. Update failed.");
        }
    };
